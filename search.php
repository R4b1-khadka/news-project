               ...
               $search_term= mysqli_real_escape_string($conn, $_GET['search']);
                ...
                ?>
                  <h2 class="page-heading">Search:<?php echo $search_term ?></h2>
                    <?php 
                    $offset= ($page-1)* $limit;
                     $sql= "SELECT post.post_id, post.title, post.description, post.post_date, post.post_img, post.category, post.author, category.category_name, user.username FROM post
