<?php include "header.php";
                    ...
                    if(isset($_POST['submit'])){
                      ...
                      $sql1="UPDATE user SET first_name='{$fname}', last_name='{$lname}', username='{$user}', role='{$role}' WHERE user_id='{$uid}';";
                      $result1= mysqli_query($conn,$sql1) or die("fucked up in here");
                    if($result1){
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="role" value="<?php echo $row['role']; ?>">
                            <?php if($row['role']==1){
                              ...
                              <option selected value='1'>Admin</option>";}else{ 
